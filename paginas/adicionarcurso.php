          ...
          <div class="col-md-4 offset-md-4 align-items-center justify-content-center container"  style="margin-top: 1%;">
            ...
            <form action = "addcurso.php" method = "POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="duracao" name="duracao" required min="18" >
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
              <label for="docente" class="form-label">Docente Responsável</label>
              <select name='id_docente' class='form-select'>
                <?php
                $connect = mysqli_connect("localhost", "root", "", "lpi_trab");
                $sql = "SELECT * FROM utilizadores where nivel_acesso=2";
