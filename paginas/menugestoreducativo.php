        ...
        <?php
          ...
          while ($row = mysqli_fetch_assoc($result1)) {
            ...
            if($row['estado_sala'] == 1){
              echo "<tr><td style='color:green'>" . $row['NomeSala'] . "</td>";
              echo "<td style='color:green'>" . $row['numVagas'] . "</td>";
              echo "<td style='color:green'>" . $row2['NomeDivisao'] . "</td></tr>";
            } else {
              echo "<tr><td style='color:red'>" . $row['NomeSala'] . "</td>";
              echo "<td style='color:red'>" . $row['numVagas'] . "</td>";
              echo "<td style='color:red'>" . $row2['NomeDivisao'] . "</td></tr>";
            }
          }
        ?>
      </tbody>
